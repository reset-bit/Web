...
// 动态渲染内容
{
    $.ajax({
        type: 'get',
        url: 'http://localhost:3000/product/model/' + pid,
...
// header和返回顶部
{
    ...
    let thresholdOfHeader = 50,
        thresholdOfHeaderSpan = 590;
			...
			<div class="count-container">
				...
				<div class="count-area">
					...
					<span class="count-wrapper"><span class="btn-decrease ${
                        count > 1 ? 'active' : ''
                    }">-</span><span class="count">${count}</span><span class="btn-increase ${
            count < 5 ? 'active' : ''
        }">+</span></span>
				</div>
